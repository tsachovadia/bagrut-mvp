        ...
        try {
            ...
            const prompt = `You are a data normalization expert. 
             ...
             2. **HEURISTICS FOR FINAL GRADE**:
                ...
                - If you see "History A" (022115) and "History B" (022116) AND "History" (022200) -> OUTPUT ONLY 022200.
             3. **IGNORE MODULES**: Do NOT output individual modules like 035806, 035807, 022115, 022116, 016106, 016117 UNLESS no final grade row exists.
             4. **FINAL OUTPUT**: Return a clean list of ~10-15 subjects (Bible, Lit, Hebrew, History, Civics, Math, English, + Electives). NOT 28 rows.
             5. **Semel**: Extract the Exam Code (סמל שאלון).
             6. **Units**: Extract units (יח״ל).
