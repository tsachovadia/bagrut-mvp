    ...
    return (
        <footer className="bg-white border-t border-gray-100 mt-auto py-2">
            <div className="max-w-7xl mx-auto px-4 text-center text-gray-400 text-sm flex flex-col items-center gap-2">
                <div className="flex flex-col gap-4 w-full border-b border-gray-100 pb-4 mb-2">
                    <p className="font-medium text-gray-500">הקהילות שלנו</p>
                    <div className="flex justify-center gap-6">
                        ...
                        <a
                            href="https://chat.whatsapp.com/GzB9XyqXyqXyqXyqXyqXy"
                            target="_blank"
                            rel="noopener noreferrer"
                            onClick={() => trackEvent('social_exit', { platform: 'whatsapp', source: 'footer' })}
