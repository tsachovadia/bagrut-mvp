...
export function CookieConsent() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t border-gray-200 p-4 shadow-lg z-50 animate-in slide-in-from-bottom-4 duration-500">
